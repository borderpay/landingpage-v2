    ...
    <div className="py-12 bg-white -mt-10 lg:mt-5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          <p className="mt-8 text-3xl text-center leading-8 font-extrabold tracking-tight text-blue-700 sm:text-4xl">
            ...
            {features.map((feature) => (
              <div key={feature.name} className="relative">
                <dt>
                  ...
                  <p className="ml-16 lg:text-2xl text-lg leading-6 font-medium font-bold text-gray-900">{feature.name}</p>
                </dt>
